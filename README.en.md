...
> **Messages are in Korean in v1.0.0.** Both implementations emit byte-identical Korean strings; that byte equality is what the cross-OS verification is built on. Localizing the messages is out of scope for v1.0.0.
